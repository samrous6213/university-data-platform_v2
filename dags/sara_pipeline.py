...
def extract_api_temp():
    print("TODO: Implémenter extraction API pour sara")
    return True

def extract_web_temp():
    print("TODO: Implémenter extraction Web pour sara")
    return True

def extract_pdf_temp():
    print("TODO: Implémenter extraction PDF pour sara")
    return True

dag = DAG(
    dag_id='sara_pipeline',
    default_args=default_args,
    description='Pipeline complet pour sara',
    schedule_interval='@daily',
    catchup=False,
    tags=['sara', 'api', 'web', 'pdf'],
)
