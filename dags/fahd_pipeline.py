...
def extract_api_temp():
    print("TODO: Implémenter extraction API pour fahd")
    return True

def extract_web_temp():
    print("TODO: Implémenter extraction Web pour fahd")
    return True

def extract_pdf_temp():
    print("TODO: Implémenter extraction PDF pour fahd")
    return True

dag = DAG(
    dag_id='fahd_pipeline',
    default_args=default_args,
    description='Pipeline complet pour fahd',
    schedule_interval='@daily',
    catchup=False,
    tags=['fahd', 'api', 'web', 'pdf'],
)
