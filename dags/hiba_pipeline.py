...
def extract_api_temp():
    print("TODO: Implémenter extraction API pour hiba")
    return True

def extract_web_temp():
    print("TODO: Implémenter extraction Web pour hiba")
    return True

def extract_pdf_temp():
    print("TODO: Implémenter extraction PDF pour hiba")
    return True

dag = DAG(
    dag_id='hiba_pipeline',
    default_args=default_args,
    description='Pipeline complet pour hiba',
    schedule_interval='@daily',
    catchup=False,
    tags=['hiba', 'api', 'web', 'pdf'],
)
