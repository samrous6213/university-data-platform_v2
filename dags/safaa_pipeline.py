...
def extract_api_temp():
    print("TODO: Implémenter extraction API pour safaa")
    return True

def extract_web_temp():
    print("TODO: Implémenter extraction Web pour safaa")
    return True

def extract_pdf_temp():
    print("TODO: Implémenter extraction PDF pour safaa")
    return True

dag = DAG(
    dag_id='safaa_pipeline',
    default_args=default_args,
    description='Pipeline complet pour safaa',
    schedule_interval='@daily',
    catchup=False,
    tags=['safaa', 'api', 'web', 'pdf'],
)
