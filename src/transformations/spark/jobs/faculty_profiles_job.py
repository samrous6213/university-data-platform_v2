"""
Point d'entree CLI du job faculty_profiles.
Execution : spark-submit ... jobs/faculty_profiles_job.py
"""
...
def main() -> int:
    ...
    try:
        summary = run_faculty_pipeline(spark)
        write_run_log(
            job_name=JOB_NAME,
            run_id=run_id,
            status="success",
