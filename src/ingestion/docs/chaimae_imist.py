...
TARGET_URL    = "https://www.imist.ma/"
SOURCE_NAME   = "imist_docs"
...
CHECKPOINT_FILE = "imist_crawl_checkpoint.txt"
...
def extract_imist_documents() -> None:
    ...
    logger.info("Starting IMIST FULL document harvest (no document cap)")
                ...
                with _get_with_retries(session, url) as res:
                    ...
                    # 🌐 CAS 2 : Page HTML -> extraction de liens
                        ...
                        for href in candidate_links:
                            ...
                            if "imist.ma" not in urlparse(full_url).netloc:
                                continue
